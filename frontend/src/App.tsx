        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            {user ? (
              ...
              <>
                <Button size="lg" className="px-8 py-3" onClick={() => window.location.href = '/tutors'}>
                  Find a Tutor
                  <ArrowRight className="ml-2 w-5 h-5" />
                </Button>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-theme-muted mb-8">
            Join thousands of students and tutors who have found success through ShikshaGuru.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            {!user && (
              <>
                  ...
                  <ProtectedRoute requireAuth={false}>
                    <div className="min-h-screen flex items-center justify-center bg-theme-background">
                      <div className="text-center">
                        <h1 className="text-2xl font-bold text-theme-text mb-4">Page Not Found</h1>
                        <p className="text-theme-muted mb-6">The page you're looking for doesn't exist.</p>
